...
function turnit(id) //这个方法就是为了隐藏下级目录
{
	...
	if (menu.style.display=="none")
	{
		...
		menu.style.display = "";
		if(imgId) 
			imgId.src="../images/midopenedfolder.gif";
		if(imgId2) 
	...
	else
	{
		...
		if(imgId) 
			imgId.src="../images/midclosedfolder.gif";
		if(imgId2) 
...
<table id="menu_order" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    ...
    <td width="123"> <a href="<s:url action='/control/order/query'/>">订单查询</a> </td>
  </tr> 
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>">待审核订单</a> </td>
  </tr>
   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=WAITPAYMENT">等待付款订单</a> </td>
  </tr> 
   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=ADMEASUREPRODUCT">正在配货订单</a> </td>
  </tr> 
   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=WAITDELIVER">等待发货订单</a> </td>
  </tr> 
   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=DELIVERED">已发货订单</a> </td>
  </tr> 
   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=RECEIVED">已收货订单</a> </td>
  </tr> 
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/order/list'/>?state=CANCEL">已取消订单</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/contorl/lockorder/list'/>">已锁定订单</a> </td>
  </tr>
</table> -->
<!-------------------------订单管理END------------------------------->
<!-------------------------产品管理START------------------------------->
...
<table id="menu_Product" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='producttypelist'/>">产品类别管理</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='brandlist'/>">产品品牌管理</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='productlist'/>">产品信息管理</a> </td>
  </tr>
</table>
<!-------------------------产品管理END------------------------------->
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('file')" style="CURSOR: hand"> 
      ...
      <img name="Imgfile_0" src="../images/clsfld.gif" align="absMiddle" border="0"> 
...
<table id="menu_file" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='uploadfilelist'/>">上传文件管理</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="uploadUI-filemanage"/>">文件上传</a> </td>
  </tr>
</table>
<!-------------------------文件管理END------------------------------->
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('file2')" style="CURSOR: hand"> 
      <img id="Imgfile2" src="../images/midclosedfolder.gif" align="absMiddle" border="0" width="16">
      <img name="Imgfile2_0" src="../images/clsfld.gif" align="absMiddle" border="0"> 
      <font face=宋体><b>云存储管理</b></font> 
    </td>
  </tr>
</table>
<table id="menu_file2" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='uploadHDFSlist'/>">网盘文件管理</a> </td>
  </tr>
<%--   <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="#"/>">文件上传</a> </td>
  </tr> --%>
</table>
<!-------------------------文件管理END------------------------------->
...
<table id="menu_user" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='/control/user/list'/>">网站用户管理</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="/control/user/query"/>">用户查询</a> </td>
  </tr>
</table> --%>
<!-------------------------网站用户管理END------------------------------->
...
<table id="menu_department" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='##'/>">留待完善</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="../images/vertline.gif" border=0><img src="../images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="../images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action='##'/>">留待完善</a> </td>
...
<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td>
      <a href="<s:url namespace="/" action='frontProductlist'/>" target="_parent">退出系统</a>
    </td>
  </tr>
</table>
</body>
